...
const title = 'Nuxt: 直观的Vue框架'
const description = 'Nuxt是一个开源框架，使得网页开发变得直观而强大。使用它，你可以自信地创建高性能且质量上乘的全栈网页应用和网站。'
useSeoMeta({
  title,
  ogTitle: title,
...
<template>
  <div v-if="page">
    <ULandingHero :ui="{ base: 'relative z-[1]' }" class="dark:bg-gradient-to-b from-gray-950 to-gray-900"
      ...
      <template #title>
        直观的<br><span class="text-primary block lg:inline-block">Vue 开发框架</span>
      </template>

      <template #description>
        Nuxt是一个
        <NuxtLink to="https://github.com/nuxt/nuxt" target="_blank">开源框架
        </NuxtLink>
        ，使得Web开发变得直观且强大。<br>可以自信地创建高性能和生产级别的全栈Web应用和网站。
